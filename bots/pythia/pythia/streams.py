...
class StreamsManager:
    ...
    def acquire_targets(self, ignore_list=[]):
        self.get_best_growers()  # TODO: change best growers
        self.compare_growers_and_balances()  # TODO: implement this mofo
        self.get_max_pair_prices()
